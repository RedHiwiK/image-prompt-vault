...
- author: @chetaslua
- source: https://x.com/chetaslua/status/2046489044243403029
- preview: https://pbs.twimg.com/media/HGaW8ECaEAAq-LZ?format=jpg&name=large
- lang: en
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
...
- preview: https://cms-assets.youmind.com/media/1776883141625_vrxilt_HGcMDzKaAAA61Vy.jpg
- lang: ja
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
...
- author: @umesh_ai
- source: https://x.com/umesh_ai/status/2046510988367945983
- preview: https://pbs.twimg.com/media/HGaqAFba0AES6z_?format=jpg&name=large
- lang: en
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
...
- author: unknown
- source: https://github.com/ZeroLu/awesome-gpt-image#coffee-journey-infographic
- preview: https://github.com/user-attachments/assets/ac0ed885-5b27-46d5-a163-f9e3c15dca3b
- lang: zh
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
...
## Create a detailed medical infographic of the human body showing major organs and how long

- author: SciTech Era
@SciTechera
·
38m
- source: https://x.com/SciTechera/status/2047275850878640596
- preview: https://pbs.twimg.com/media/HGlihuLasAAiJ0I?format=jpg&name=medium
- lang: en
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
...
- preview: https://cdn.gptimagelab.com/prompt-libraries/awesome-gptimage2-prompts/048-x-2040489463550529755/f1-ferrari-progression-infographic-1.jpg
- lang: zh
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts

```
信息图显示了 F1 法拉利赛车从旧款到最新款 2026 年法拉利一级方程式赛车 SF-26（代号为 Project 678）的进展，该赛车于 2026 年 1 月 23 日正式发布。
```

## FPSO Engineering Infographic

- author: @diogosantosbr
- source: https://x.com/diogosantosbr/status/2047255035935867350
- preview: https://pbs.twimg.com/media/HGlPmZ_XYAEN21a?format=jpg&name=large
- lang: en
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
...
## Knowing everything you know about me, make an infographic of me. Make a 3D cartoon style i

- author: 𝔄𝔫𝔤𝔢𝔩𝔦𝔫𝔞 𝔖𝔥𝔞𝔥𝔦𝔫𝔶𝔞𝔫
@fashsplash_ai
·
2h
- source: https://x.com/fashsplash_ai/status/2047255478787326189
- preview: https://pbs.twimg.com/media/HGlQAC4WQAAa-Xi?format=jpg&name=large
- lang: en
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts

```
Knowing everything you know about me, make an infographic of me. Make a 3D cartoon style image. 3. That's all) #ai #aitools #chatgpt
```

## Knowing everything you know about me. Make a anime style infographic of me.

- author: Givros
@givros
·
1h
- source: https://x.com/givros/status/2047267215217475758
- preview: https://pbs.twimg.com/media/HGlZ8WnWQAApJL0?format=jpg&name=large
- lang: en
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
...
- author: lupusk9
- source: https://www.reddit.com/r/ChatGPT/comments/1su2fe3/leading_causes_of_death_infographic_with_image_20/
- preview: https://preview.redd.it/leading-causes-of-death-infographic-with-image-2-0-v0-1m4thkpxo1xg1.png?width=640&crop=smart&auto=webp&s=13e481fd850f710b82686f65486b3995797ae75e
- lang: en
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
...
## Mastering Adobe: A Visual Guide to Creative Tools

- author: @LudovicCreator
- source: https://promptgather.io/prompts/gpt-image-2
- preview: https://pbs.twimg.com/media/HGb_qmAXsAEPuKk.jpg
- lang: en
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts

```
Create a modern, visually engaging infographic showcasing Adobe Creative Cloud tools. Use a clean layout with sections and icons. Include the following tools with short descriptions: Photoshop (photo editing), Illustrator (vector graphics), Premiere Pro (video editing), After Effects (motion graphics), InDesign (layout & publishing), Lightroom (photo management), XD (UI/UX design). Use a professional color palette inspired by Adobe branding (dark background with vibrant accent colors). Include minimal text, clear headings, and simple icons for each tool. Add subtle gradients, geometric shapes, and a tech/creative aesthetic. Ensure the design is balanced, easy to read, and suitable for social media or presentation
```

## Meme 生命周期编辑信息图

- author: 8fstudioz
- source: https://x.com/8fstudioz/status/2047412755976552812
- preview: https://cms-assets.youmind.com/media/1777022591434_2sp4by_HGnIN6qXcAAPrrV.jpg
- lang: zh
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts

```
{"type":"编辑信息图海报","style":"瑞士现代平面设计，融合粗野主义排版、极简网格布局、单色基调配以酸橙色点缀、半色调纹理、拼贴元素、简洁的留白，以及在极浅暖灰色背景上的高对比度黑色文字","subject":"一张解释互联网 Meme 作为一种文化系统生命周期的信息图","canvas":{"orientation":"纵向","background":"极浅灰色纸张纹理"},"layout":{"headline_block":{"position":"左上角","title":"Meme 生命周期","subtitle_top":"今日爆火，明日即逝。","body":"Meme 的传播速度极快。它们诞生、传播、演变、达到顶峰并逐渐消退——最终被铭记、重混或遗忘。这就是循环。"},"intro_icon":{"position":"左上角标题附近","description":"一个小型的轮廓正方形，内含一个地球图标，右侧带有简短说明","caption":"// 注意力经济中的通用循环"},"left_sidebar":{"position":"最左侧垂直排列","count":4,"items":["心形轮廓图标","对话气泡轮廓图标","转发/转推轮廓图标","书签轮廓图标"]},"main_sections":{"count":5,"path":"由细黑色曲线箭头连接，在页面上形成一个循环路径","sections":[{"number":"01","title":"诞生","position":"右上角","visual":"黑白半色调猫咪肖像，正视前方，戴着超大霓虹酸橙色星形太阳镜；猫咪身后是一个带有小写字母 'a' 的锯齿状酸橙色星爆图案和一个酸橙色虚线矩形","body":"灵感的火花。新的格式，新的笑话，新的语境。它是小众的。它是一切。"},{"number":"02","title":"传播","position":"中右侧","visual":"巨大的变形黑色文字 'SPREAD'，垂直拉伸并液化，周围有几个小型酸橙色方形箭头图标和微小的黑色裁剪/角标","body":"分享、转发、再分享。它脱离了原始语境。它找到了受众。"},{"number":"03","title":"演变","position":"中左侧","visual":"4 个重叠元素的拼贴：一个带有浏览器窗口边框的灰度蒙娜丽莎裁剪图，前方有一个巨大的小写酸橙色 'e'，右侧是一个黑白像素艺术块形状，以及一个小的酸橙色便签框，列出了 5 次 'evolve' 一词，最后一行逐渐淡出","body":"重混。重新语境化。它变异成新的形式。笑话要么适应，要么消亡。"},{"number":"04","title":"巅峰","position":"中右侧（低于传播）","visual":"由细垂直条组成的酸橙色钟形曲线直方图，位于黑色测量框内，带有一个小型中心十字准线","body":"最高可见度。主流采纳。每个人都懂了。然后它开始变得陈旧。"},{"number":"05","title":"消退","position":"左下至中下","visual":"粗体黑色小写单词 'fade'，向右逐渐分解为散落的黑色颗粒","body":"兴趣下降。新的 Meme 取而代之。它逐渐淡出，走向默默无闻——或成为遗产。"}]},"bottom_callout":{"position":"左下角","icon":"带有白色星号/星形符号的小型黑色正方形","text":"Meme 是暂时的。但影响力不是……","button":"你会创造什么？"},"footer":{"position":"底部全宽","count":4,"columns":[{"label":"格式：","value":"数字文化产物"},{"label":"周期时长：","value":"几秒到几年（或许永远）"},{"label":"燃料：","value":"创造力、语境、社区"},{"label":"结果：","value":"欢笑、连接、文化"}],"extra_icon":"最右下角的小型目标/十字准线图标"}},"typography":{"headline":"超大号粗体新格罗特斯克无衬线字体","section_numbers":"超大号粗体压缩无衬线字体","section_titles":"大写粗体无衬线字体，配有酸橙色下划线强调","body":"小型简洁无衬线字体，左对齐","footer":"小型大写标签，配以较轻的正文文字"},"color_palette":{"base":"黑色和灰白色","accent":"酸橙色 / 黄绿色","secondary":"灰度半色调"},"composition_notes":"编辑海报平衡感，左侧为超大标题，右侧为模块化信息图面板，大量留白，精确对齐，当代设计杂志美学，清晰的矢量线条与粗糙的栅格拼贴纹理混合"}
```

## Miniature Majesty: A City in the Palm of Your Hand

- author: @0x00_Krypt
- source: https://promptgather.io/prompts/gpt-image-2
- preview: https://pbs.twimg.com/media/HGbZTTHbAAMPoXE.jpg
- lang: en
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts

```
A vertical, portrait-oriented, photorealistic close-up photograph of an expansive, incredibly detailed physical miniature geography and city model of [Insert City Name], filling the entire frame.  The landscape is a sprawling 3D topographic map, rich with organic textures: rugged mountain ranges with diverse elevations, deep gorges, and winding scale-model rivers that reflect the light. The surface shows realistic details of earth, rock, rich foliage, and water, resembling a masterfully crafted museum diorama.  Nested organically within this terrain is a highly detailed miniature metropolis. Thousands of tiny, intricate buildings, roads, bridges, and urban infrastructure are integrated into the landscape. The city's most recognizable iconic landmarks rise significantly above the surrounding architecture, serving as the focal point.  Strong, natural sunlight from the side casts long, realistic shadows from the mountains and skyscrapers across the textured landscape, creating depth and drama. The depth of field is shallow (tilt-shift style), keeping the central city and its immediate surroundings in sharp focus while gently blurring the distant edges of the sprawling terrain. The entire model appears to be a tangible, physical object bathed in real light. --ar 9:16
```

## Photoshop Shortcuts Infographic

- author: @icreatelife
- source: https://x.com/icreatelife/status/2046934865849786796
- preview: https://pbs.twimg.com/media/HGgr_I8X0AAYxYh?format=jpg&name=large
- lang: en
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
...
## Semiconductor Manufacturing Infographic

- author: @rohanpaul_ai
- source: https://x.com/rohanpaul_ai/status/2047047274774331747
- preview: https://pbs.twimg.com/media/HGiSRK4awAAgmfQ?format=jpg&name=large
- lang: en
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
...
## Understanding Heart Attacks: A Detailed Infographic

- author: @LudovicCreator
- source: https://promptgather.io/prompts/gpt-image-2
- preview: https://pbs.twimg.com/media/HGgFPWjWQAAnIHp.jpg
- lang: en
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
...
## Unlock Your Fitness Potential with Tailored Training Plans

- author: @MrLarus
- source: https://promptgather.io/prompts/gpt-image-2
- preview: https://pbs.twimg.com/media/HGbW7-LXYAANNeF.jpg
- lang: zh
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts

```
我生成的主题是：胸肌、腹肌、引体向上、附身臂屈伸，都有针对性的拆解，对新手友好，信息量很足！
...
- author: @Angaisb_
- source: https://x.com/Angaisb_/status/2046666389734179018
- preview: https://pbs.twimg.com/media/HGYD-Y4bMAA0KxJ?format=jpg&name=large
- lang: en
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
...
- author: Stella Lin
- source: https://x.com/StellaLinNotes/status/2047116273319088260
- preview: https://cms-assets.youmind.com/media/1777022557600_511jsb_HGjRFEZbkAAQ1ny.jpg
- lang: zh
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
...
- author: 程序员Left
- source: https://x.com/coder_left/status/2047133651318755587
- preview: https://cms-assets.youmind.com/media/1777022554202_8ghln8_HGjf_J-bAAA4x5S.jpg
- lang: zh
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
...
- author: TOM-RICKY
- source: https://x.com/TOMRICH1619/status/2047317712205222347
- preview: https://cms-assets.youmind.com/media/1777022509783_u6b8u1_HGmINR3acAAGCyE.jpg
- lang: zh
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
...
- author: 𝐌
- source: https://x.com/Strength04_X/status/2047283829652812276
- preview: https://cms-assets.youmind.com/media/1777022496150_zxxl34_HGlptubakAAQ3DF.jpg
- lang: zh
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
...
- preview: https://cdn.gptimagelab.com/prompt-libraries/awesome-gptimage2-prompts/site-additions/058-x-discussions-data-science-machine-learning-landscape-infographic/data-science-machine-learning-landscape-infographic-1.webp
- lang: zh
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
...
- author: Kohya Tech
- source: https://x.com/kohya_tech/status/2047094394860474508
- preview: https://cms-assets.youmind.com/media/1776936913739_zuxbnj_HGi8-4rbYAA5C1x.jpg
- lang: ja
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
...
- author: garlo
- source: https://x.com/paulai_/status/2047415757105967575
- preview: https://cms-assets.youmind.com/media/1777022610930_me3su4_HGnhxouWQAAefpR.jpg
- lang: zh
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts

```
一幅电影感十足、氛围阴郁的劫案策划场景，背景为深夜昏暗的办公室，采用写实的惊悚片风格拍摄。一名成年男子背对镜头，侧身站立，正在一块巨大的白板上书写，白板写满了战术笔记、建筑草图、平面图、箭头、路线和手绘图表。他留着深色卷发，身穿深橄榄色或炭灰色休闲夹克，搭配深色长裤，展现出策划大师的形象。白板是视觉焦点，包含多个可读的规划区域：左上角标题写着“OPERATION NIGHTHAWK”；左侧栏分为 3 个部分，分别标注为“OBJECTIVE”（目标）、“TARGET”（目标对象）和“TIMELINE”（时间线）；右上角有 2 个标注的图表区域，分别为“ENTRY PLAN”（进入计划）和“CAMERA NETWORK”（监控网络）；中右下方有 4 个标注的规划区块，分别为“TRANSIT”（交通）、“EQUIPMENT”（装备）、“HOTEL ROUTE”（酒店路线）和“CONTINGENCIES”（应急预案）。包含建筑立面草图、屋顶通道图、装卸区笔记、房间标签、黑色和红色记号笔绘制的箭头，以及下方中心附近的一辆小型货车草图。房间光线温暖且阴影重重，带有琥珀色的实用照明。画面左侧展示了一盏台灯，照亮了摆满散乱文件的深色木质书桌，墙上垂直悬挂着 3 张黑白照片。构图为中远景过肩镜头，男子位于画面偏左中心，白板占据背景主导地位。高对比度，柔和的电影颗粒感，紧张的氛围，写实的质感，呈现出类似于天才策划者准备劫案的精品犯罪剧美学，但不描绘任何特定的受版权保护的角色。在右上角添加白色的“Pollo.ai”水印。
```
...
- preview: https://cms-assets.youmind.com/media/1776936732453_s5p113_HGfguvbbYAAi4mv.jpg
- lang: zh
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
...
- source: https://x.com/ElNutriDice/status/2047023858578870545
- preview: https://cms-assets.youmind.com/media/1776936900327_rg1cuc_HGh9WWAXsAAK3TO.jpg
- lang: zh
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
