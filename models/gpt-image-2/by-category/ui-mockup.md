...
- preview: https://cdn.gptimagelab.com/prompt-libraries/awesome-gptimage2-prompts/011-x-2045082518089810073/916-cosplayer-portrait-screenshot-1.jpg
- lang: zh
- quality: A
...
- author: @stark_nico99
- source: https://x.com/stark_nico99/status/2045836554451706125
- preview: https://raw.githubusercontent.com/ZeroLu/awesome-gpt-image/main/assets/opennana/custom-style-ui-system.jpeg
- lang: en
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
...
- author: @alanblogsooo
- source: https://x.com/alanblogsooo/status/2044784762594918516
- preview: https://raw.githubusercontent.com/ZeroLu/awesome-gpt-image/main/assets/opennana/liu-yifei-douyin-live-chat.jpg
- lang: en
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
...
## Isometric Google Stock Dashboard Miniature 3D Scene

- author: @dotey
- source: https://promptgather.io/prompts/gpt-image-2
- preview: https://pbs.twimg.com/media/HGdnsuJXcAAbEvm.jpg
- lang: en
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
...
* Aspect ratio: {User input, default 4:3}
...
- author: unknown
- source: https://github.com/ZeroLu/awesome-gpt-image#live-streaming-screenshot
- preview: https://github.com/user-attachments/assets/be639d3b-617b-4332-98eb-4deb2484ac66
- lang: en
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
...
- preview: https://github.com/user-attachments/assets/88f33c6a-c307-4e7a-af7e-5f692cbf41a1
- lang: zh
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
...
- preview: https://raw.githubusercontent.com/ZeroLu/awesome-gpt-image/main/assets/opennana/song-dynasty-cyber-social-feed.jpg
- lang: en
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
...
- source: https://x.com/rionaifantasy/status/2045356799751303194
- preview: https://raw.githubusercontent.com/ZeroLu/awesome-gpt-image/main/assets/opennana/terminator-taobao-page.jpeg
- lang: en
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
...
- author: @flowersslop
- source: https://x.com/flowersslop/status/2040261168460108213
- preview: https://pbs.twimg.com/media/HFByWu7bsAAxlJd?format=jpg&name=large
- lang: en
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts
...
- preview: https://cdn.gptimagelab.com/prompt-libraries/awesome-gptimage2-prompts/013-x-2045190582453350748/doodle-sketch-ai-builder-1.jpg
- lang: zh
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts

```
以涂鸦素描风格描绘“强大的人工智能建造者”。整体图像应该感觉像是一个快速、自由形式的视觉草稿，具有松散的失真、即兴手绘的能量和笔记本般的自发性。线条应该感觉随意、夸张、粗细各异，有点凌乱，但仍然有节奏和表现力。强调简单、夸张、幽默和宽松，而不是严格的现实主义或精美的细节。使用具有粗糙干刷纹理的宽色块。不均匀的笔迹、暴露的白色间隙、过度绘制的斑块和分层的笔触都是受欢迎的。调色板应该自动适应主题，但整体外观必须保持涂鸦、素描和概括。避免透明的水彩晕染、柔和的绘画渐变、纸张纹理、雾霾或梦幻般的柔软度。保持背景大部分为空，这样构图会感觉轻盈、未完成且经过精心设计。您可以添加一些辅助符号、箭头、注释、圆圈、重复线条、手写标记或涂鸦元素来增强素描本的感觉，但不要过度拥挤布局或破坏负空间。图像内容不需要事先硬性规定；让“强大的人工智能构建者”驱动最合适的主题形式、手势、相关道具、符号或简化的环境。整件作品应以夸张的涂鸦素描语言保持统一，避免现实复杂的背景或过度构建的场景装饰。将签名“BlanPlan”自然地融入构图中，作为微妙但清晰可读的艺术家标记，放置在左下角、右下角或标题附近。签名应该给人精致、克制和优质的感觉，而不是过大、廉价或破坏构图。
```
...
- preview: https://cdn.gptimagelab.com/prompt-libraries/awesome-gptimage2-prompts/017-x-2044982293497090128/modern-saas-homepage-design-boards-1.jpg
- lang: zh
- quality: A
- upstream: peterRooo/awesome-gpt-image-2-prompts

```
现代SaaS网站主页，figma风格，干净的导航栏，带有浮动提示输入UI的英雄部分，圆形卡片，柔和的阴影，简约的设计
